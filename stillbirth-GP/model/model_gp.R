...
mod.gp<-jags.parallel(data = jags.data,
                          parameters.to.save=parnames.to.save, 
                          model.file ="model/model_gp.txt", n.chains = 3, n.iter = 12000, n.burnin = 3000, n.thin=9)
saveRDS(mod.ar1MVN, file ="output/mod.gp.rds")
# end file 
